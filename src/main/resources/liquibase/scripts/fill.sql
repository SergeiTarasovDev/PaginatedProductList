...
-- VALUES ('Кроссовки мужские', 6200), ('Сланцы', 300),
--        ('Пальто', 3199), ('Футболка', 1200),
--        ('Молоко 3.2%', 54), ('Молоко 2.5%', 50),
--        ('Яйцо куринное 10шт, СО', 70), ('Яйцо куринное 30шт, С1', 190),
--        ('Toryta Corolla', 2100000), ('Subaru Impreza', 1700000), ('Honda Civic', 1200000),
--        ('Ноутбук ASUS', 40290), ('Ноутбук HP', 65900),
--        ('Жесткий диск SEAGATE', 4300), ('Жесткий диск WD', 5600);
